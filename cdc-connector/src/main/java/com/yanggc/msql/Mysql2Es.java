...
public class Mysql2Es {
    ...
    public static void main(String[] args) throws Exception {
        ...
        StreamTableEnvironment tableEnv = StreamTableEnvironment.create(env);
         ...
         String CONNECTOR_TARGET_ES = " 'connector' = 'elasticsearch-7', 'hosts' = 'http://192.168.1.71:9200', 'index' = 'enriched_orders'";
        ...
        //插入ES
        tableEnv.executeSql("CREATE TABLE enriched_orders ( order_id INT,order_date TIMESTAMP ( 0 ),customer_name STRING,price DECIMAL ( 10, 5 ),product_id INT,order_status BOOLEAN,product_name STRING,product_description PRIMARY KEY ( order_id ) NOT ENFORCED )" +
                "WITH ("+CONNECTOR_TARGET_ES+"'table-name' = 'orders'");
